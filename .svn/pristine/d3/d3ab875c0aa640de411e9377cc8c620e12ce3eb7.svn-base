...
export declare class IonicSelectableComponent implements ControlValueAccessor, OnInit, DoCheck {
    ...
    private readonly _hasIonLabelCssClass;
    private readonly _hasDefaultIonLabelCssClass;
    private readonly _hasFixedIonLabelCssClass;
    private readonly _hasStackedIonLabelCssClass;
    private readonly _hasFloatingIonLabelCssClass;
